  ...
  const detail = [
    {
      ...
      topImage: AMBITIOUS,
      logo: AMBITIOUS_LOGO,
      desc: "Our business is competitive. We push ourselves and each other to greatness, but not at all costs. Being a team player and doing the right thing comes first.",
    },
    {
      id: 2,
      topImage: CURIOUS,
      logo: CURIOUS_LOGO,
      desc: "The world is changing faster than ever. No one has all the answers. We are humble and always listen and seek to learn and understand.",
    },
    {
      id: 3,
      topImage: EMPATHETIC,
      logo: EMPATHETIC_LOGO,
      desc: "There’s an age-old wisdom in walking a mile in another’s shoes. We do that every day, whether it’s with customers or colleagues.",
    },
    {
      id: 4,
      topImage: COURAGEOUS,
      logo: COURAGEOUS_LOGO,
      desc: "Prudential's success and culture belongs to all of us - it's our shared legacy. We do the right thing and bring our full selves to work to build it together.",
    },
  ];
